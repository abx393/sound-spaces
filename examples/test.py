...
for scene_config in reverb_config['data']:
    ...
    for i in range(2):
        ...
        plt.savefig(os.path.join('/content/drive/MyDrive/spoken_navigation_output', scene_id, setup_id, 'ir{}'.format(i)))
    ...
    for i in range(2):
        ...
        plt.savefig(os.path.join('/content/drive/MyDrive/spoken_navigation_output', scene_id, setup_id, 'ir_precomputed{}'.format(i)))
    ...
    for i in range(2):
        ...
        plt.savefig(os.path.join('/content/drive/MyDrive/spoken_navigation_output', scene_id, setup_id, 'speech_convolved_with_ir{}'.format(i)))
    plt.clf()
